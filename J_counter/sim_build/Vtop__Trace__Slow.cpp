...
void Vtop::traceInitSub0(void* userp, VerilatedFst* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+3,"out",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 3,0);
        tracep->declBit(c+4,"jcounter clk",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
        tracep->declBit(c+5,"jcounter reset",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
        tracep->declBus(c+6,"jcounter out",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 3,0);
    }
}
...
void Vtop::traceFullSub0(void* userp, VerilatedFst* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+4,(vlTOPp->jcounter__DOT__clk));
        tracep->fullBit(oldp+5,(vlTOPp->jcounter__DOT__reset));
        tracep->fullCData(oldp+6,(vlTOPp->jcounter__DOT__out),4);
    }
}

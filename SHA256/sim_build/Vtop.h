...
VL_MODULE(Vtop) {
  public:
    ...
    VL_IN8(clk,0,0);
    VL_IN8(reset,0,0);
    VL_INW(message,511,0,16);
    VL_OUTW(hash,255,0,8);
    
    // LOCAL SIGNALS
    // Internals; generally not touched by application code
    CData/*0:0*/ sha256__DOT__clk;
    CData/*0:0*/ sha256__DOT__reset;
    WData/*511:0*/ sha256__DOT__message[16];
    WData/*255:0*/ sha256__DOT__hash[8];
    ...
    IData/*31:0*/ sha256__DOT__temp1;
    IData/*31:0*/ sha256__DOT__temp2;
    IData/*31:0*/ sha256__DOT__K[64];
    IData/*31:0*/ sha256__DOT__H[8];
    IData/*31:0*/ sha256__DOT__W[64];

...
void Vtop::traceInitSub0(void* userp, VerilatedFst* tracep) {
    ...
    // Body
    {
        tracep->declBit(c+1,"J",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
        tracep->declBit(c+2,"K",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
        ...
        tracep->declBit(c+7,"JK J",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
        tracep->declBit(c+8,"JK K",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
        tracep->declBit(c+9,"JK clk",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
        tracep->declBit(c+10,"JK reset",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
        tracep->declBit(c+11,"JK q",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
        tracep->declBit(c+12,"JK qbar",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    }
}
...
void Vtop::traceFullSub0(void* userp, VerilatedFst* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+7,(vlTOPp->JK__DOT__J));
        tracep->fullBit(oldp+8,(vlTOPp->JK__DOT__K));
        tracep->fullBit(oldp+9,(vlTOPp->JK__DOT__clk));
        tracep->fullBit(oldp+10,(vlTOPp->JK__DOT__reset));
        tracep->fullBit(oldp+11,(vlTOPp->JK__DOT__q));
        tracep->fullBit(oldp+12,(vlTOPp->JK__DOT__qbar));
    }
}

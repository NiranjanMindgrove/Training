...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , read_req_size{vlSymsp->TOP.read_req_size}
    , EN_read_req{vlSymsp->TOP.EN_read_req}
    , RDY_read_req{vlSymsp->TOP.RDY_read_req}
    , write_req_size{vlSymsp->TOP.write_req_size}
    , EN_write_req{vlSymsp->TOP.EN_write_req}
    , write_req{vlSymsp->TOP.write_req}
    , RDY_write_req{vlSymsp->TOP.RDY_write_req}
    , io_SIN{vlSymsp->TOP.io_SIN}
    , io_SOUT{vlSymsp->TOP.io_SOUT}
    , io_SOUT_EN{vlSymsp->TOP.io_SOUT_EN}
    , __SYM__interrupt{vlSymsp->TOP.__SYM__interrupt}
    , outp_ready{vlSymsp->TOP.outp_ready}
    , can_take_inp{vlSymsp->TOP.can_take_inp}
    , uart_ren{vlSymsp->TOP.uart_ren}
    , read_req_addr{vlSymsp->TOP.read_req_addr}
    , write_req_addr{vlSymsp->TOP.write_req_addr}
    , write_req_data{vlSymsp->TOP.write_req_data}

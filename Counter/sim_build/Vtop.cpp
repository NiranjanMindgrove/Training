...
void Vtop::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/niranjan/Documents/Training_Projects/HDL_Codes/Counter/counter.v", 1, "",
...
VL_INLINE_OPT void Vtop::_combo__TOP__1(Vtop__Syms* __restrict vlSymsp) {
    ...
    Vtop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->counter__DOT__clk = vlTOPp->clk;
    vlTOPp->counter__DOT__reset = vlTOPp->reset;
}
...
VL_INLINE_OPT void Vtop::_sequent__TOP__3(Vtop__Syms* __restrict vlSymsp) {
    ...
    Vtop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->counter__DOT__count = ((IData)(vlTOPp->reset)
                                    ? 0U : (0xffU & 
                                            ((IData)(1U) 
                                             + (IData)(vlTOPp->counter__DOT__count))));
    vlTOPp->count = vlTOPp->counter__DOT__count;
}

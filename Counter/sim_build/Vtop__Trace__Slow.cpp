...
void Vtop::traceInitSub0(void* userp, VerilatedFst* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+3,"count",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 7,0);
        tracep->declBit(c+4,"counter clk",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
        tracep->declBit(c+5,"counter reset",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
        tracep->declBus(c+6,"counter count",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 7,0);
    }
}
...
void Vtop::traceFullSub0(void* userp, VerilatedFst* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+3,(vlTOPp->count),8);
        tracep->fullBit(oldp+4,(vlTOPp->counter__DOT__clk));
        tracep->fullBit(oldp+5,(vlTOPp->counter__DOT__reset));
        tracep->fullCData(oldp+6,(vlTOPp->counter__DOT__count),8);
    }
}
